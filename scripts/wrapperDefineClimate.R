...
soloSites<-read.csv(file = "~/GitHub/NEON-FIU-document-IPT/dataQAQC/solo sites.txt", stringsAsFactors = F, header = F)
#runThese=soloSites[24:37,1] # monolith's split of sites
#runThese=soloSites[1:18, 1] # rhlee12 CyVerse split of sites

clustSites<-read.csv(file = "~/GitHub/NEON-FIU-document-IPT/dataQAQC/sites_clusters.txt", stringsAsFactors = F, header = F)
